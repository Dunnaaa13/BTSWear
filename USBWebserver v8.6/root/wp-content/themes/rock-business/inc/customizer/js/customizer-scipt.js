...
*/
 jQuery(document).ready(function($) {
    $('#rock-img-container li label img').click(function(){    	
        $('#rock-img-container li').each(function(){
            $(this).find('img').removeClass ('rock-radio-img-selected') ;
        });
        $(this).addClass ('rock-radio-img-selected') ;
    });                    
});
