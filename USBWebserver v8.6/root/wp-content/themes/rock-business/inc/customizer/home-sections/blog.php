...
$wp_customize->add_section( 'section_home_blog',
	array(
		'title'      => __( 'Blog Section', 'rock-business' ),
		'priority'   => 100,
...
$wp_customize->add_control('theme_options[disable_blog_section]', 
	array(		
	'label' 	=> __('Disable Blog Section', 'rock-business'),
...
$wp_customize->add_control('theme_options[blog_title]', 
	...
	'active_callback' => 'rock_business_blog_active',		
	'type'        => 'text'
	)
);

//Setting Blog subtitle
...
$wp_customize->add_control(
	new rock_business_Dropdown_Taxonomies_Control( $wp_customize, 'theme_options[blog_category]',
		array(
		'label'    => __( 'Select Category', 'rock-business' ),
		'section'  => 'section_home_blog',
...
$wp_customize->add_control( 'theme_options[blog_number]',
	array(
		'label'       => __( 'Number of Posts', 'rock-business' ),
		'description' => __('Maximum number of post to show is 6.', 'rock-business'),
		'section'     => 'section_home_blog',
		'active_callback' => 'rock_business_blog_active',		
		'type'        => 'number',
		'priority'    => 100,
