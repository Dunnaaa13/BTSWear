...
$wp_customize->add_section( 'section_cta',
	array(
		'title'      => __( 'Call To Action', 'rock-business' ),
		'priority'   => 100,
...
$wp_customize->add_control('theme_options[disable_cta_section]', 
	array(		
	'label' 	=> __('Disable Call to action section', 'rock-business'),
	'section' 	=> 'section_cta',
...
$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize,
	...
	array(
	'label'       => __('Background Image', 'rock-business'),
	'section'     => 'section_cta',   
	'settings'    => 'theme_options[background_cta_section]',		
	'active_callback' => 'rock_business_cta_active',
	'type'        => 'image',
	)
	)
);
...
$wp_customize->add_control('theme_options[cta_small_description]', 
	array(
	'label'       => __('CTA Small Font Description', 'rock-business'),
	'section'     => 'section_cta',   
...
$wp_customize->add_control('theme_options[cta_description]', 
	array(
	'label'       => __('CTA Big Font Description', 'rock-business'),
	'section'     => 'section_cta',   
...
$wp_customize->add_control('theme_options[cta_button_label]', 
	array(
	'label'       => __('Button Label', 'rock-business'),
	'section'     => 'section_cta',   
...
$wp_customize->add_control('theme_options[cta_button_url]', 
	array(
	'label'       => __('Button Url', 'rock-business'),
	'section'     => 'section_cta',   
