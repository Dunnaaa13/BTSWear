...
if ( 'posts' != get_option( 'show_on_front' ) ){ 
    get_header(); ?>
    <?php $enabled_sections = rock_business_get_sections();
    if( is_array( $enabled_sections ) ) {
        foreach( $enabled_sections as $section ) {

            if( ( $section['id'] == 'featured-slider' ) ){ ?>
                <?php $disable_featured_slider = rock_business_get_option( 'disable_featured_slider' );
            ...
            <?php } elseif( $section['id'] == 'additional-info' ) { ?>
                <?php $disable_additional_info_section = rock_business_get_option( 'disable_additional_info_section' );
            ...
            <?php } elseif( $section['id'] == 'cta' ) { ?>
                <?php $disable_cta_section = rock_business_get_option( 'disable_cta_section' );
                $background_cta_section = rock_business_get_option( 'background_cta_section' );
            ...
            <?php } elseif( $section['id'] == 'gallery' ) { ?>
                <?php $disable_gallery_section = rock_business_get_option( 'disable_gallery_section' );
            ...
            elseif( ( $section['id'] == 'blog' ) ){ ?>
                <?php $disable_blog_section = rock_business_get_option( 'disable_blog_section' );
